...
<html lang="en">
	...
	<body>
		...
		<!-- server testing mode -->
		<?php
		//if ( (base_url() . 'index.php' == 'http://192.168.137.1' . $_SERVER['PHP_SELF']) || (base_url() . 'index.php/home' == 'http://192.168.137.1' . $_SERVER['PHP_SELF']) ) echo '<div id="two-wrapper">';
		?>
		<!-- end of test section -->
		<div id="two-wrapper">
				...
				<nav class="navbar navbar-default" role="navigation">
					...
					<div class="collapse navbar-collapse" id="example-navbar-collapse">
						<ul class="nav navbar-nav navbar-right">
							<li class="current"><a href="<?php echo base_url(); ?>">D5</a></li>
